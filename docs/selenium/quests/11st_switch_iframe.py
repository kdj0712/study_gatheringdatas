...
def Connect(): # 전체 과정을 통합한 function의 이름으로 Connect라는 이름을 지정한다
    ...
    collection = database['11st_comments'] # 데이터베이스에서 11st_comments 이라는 collection에 연결
...
browser.get("https://www.11st.co.kr/products/3421935505?&trTypeCd=20&trCtgrNo=1002724")
